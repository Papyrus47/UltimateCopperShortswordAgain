...
namespace LogSpiralLibrary.ForFun.StabProj
{
    public class StabProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(TextureAssets.Extra[98].Value, Projectile.Center - Main.screenPosition, null, mainColor with { A = 0 } * fac,  Projectile.ai[0] + MathHelper.PiOver2, new(36), new Vector2(2, 70) * fac * Projectile.scale, 0, 0);
            Main.EntitySpriteDraw(TextureAssets.Extra[98].Value, Projectile.Center - Main.screenPosition, null, Color.White with { A = 0 } * fac, Projectile.ai[0] + MathHelper.PiOver2, new(36), new Vector2(2, 70) * fac * .75f * Projectile.scale, 0, 0);
